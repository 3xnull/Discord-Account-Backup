...
print(Fore.LIGHTMAGENTA_EX + ''''
            ...
            ╚═╝     ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═════╝     ╚═╝     ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝
                  ...
                  Made By MamadMoon,
                  GitHub: https://github.com/MamadMoon
                  Discord: Mamad Moon-#0294
                  Youtube:                                                                                        
''')

# file = open('accounttoken.txt', 'r')
# token = file.read()

token = input(Fore.LIGHTWHITE_EX + "[" + Fore.LIGHTGREEN_EX + "+" + Fore.LIGHTWHITE_EX + "] " + str("Please Enter Your Account Token : "))
...
while True:
    os.system('title [Discord Account Backup Bot by MamadMoon] - Main Menu')
